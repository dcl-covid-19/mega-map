...
###### Faq
1. *What is a Web Scraper program?*
```
...
```
1. *What is Upload csv to Airtable?*
```
...
1. *What is Carto?*
```
	Carto is a relational database. For documentation see this https://docs.carto.com/
```
1. *Why do we have one table in CARTO but 6 different tables in airtable?*
```
...
```
1. *Why can’t we go directly to CARTO tables?*
```
